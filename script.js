...
const menuData = {
    vegetarian: [
        { name: "Gobhi Aloo (Q)", price: 90, emoji: "🥔", description: "Golden, crispy comfort that melts in your mouth" },
        { name: "Gobhi Aloo (H)", price: 150, emoji: "🥔", description: "Golden, crispy comfort that melts in your mouth" },
        { name: "Gobhi Aloo (F)", price: 210, emoji: "🥔", description: "Golden, crispy comfort that melts in your mouth" },
        { name: "Bhindi Aloo (Q)", price: 90, emoji: "🥬", description: "Tender, aromatic and absolutely irresistible" },
        { name: "Bhindi Aloo (H)", price: 150, emoji: "🥬", description: "Tender, aromatic and absolutely irresistible" },
        { name: "Bhindi Aloo (F)", price: 210, emoji: "🥬", description: "Tender, aromatic and absolutely irresistible" },
        { name: "Egg Bhurji (Q)", price: 90, emoji: "🥚", description: "Fluffy scrambled delight bursting with flavor" },
        { name: "Egg Bhurji (H)", price: 150, emoji: "🥚", description: "Fluffy scrambled delight bursting with flavor" },
        { name: "Egg Bhurji (F)", price: 210, emoji: "🥚", description: "Fluffy scrambled delight bursting with flavor" },
        { name: "Soybean Aloo (Q)", price: 90, emoji: "🌱", description: "Hearty, wholesome and incredibly satisfying" },
        { name: "Soybean Aloo (H)", price: 150, emoji: "🌱", description: "Hearty, wholesome and incredibly satisfying" },
        { name: "Soybean Aloo (F)", price: 210, emoji: "🌱", description: "Hearty, wholesome and incredibly satisfying" },
        { name: "Aloo Jeera (Q)", price: 90, emoji: "🥔", description: "Rustic charm in every bite, perfectly spiced" },
        { name: "Aloo Jeera (H)", price: 150, emoji: "🥔", description: "Rustic charm in every bite, perfectly spiced" },
        { name: "Aloo Jeera (F)", price: 210, emoji: "🥔", description: "Rustic charm in every bite, perfectly spiced" },
        { name: "Rajma Masala (Q)", price: 90, emoji: "🥣", description: "Rich, creamy and deeply satisfying" },
        { name: "Rajma Masala (H)", price: 150, emoji: "🥣", description: "Rich, creamy and deeply satisfying" },
        { name: "Rajma Masala (F)", price: 210, emoji: "🥣", description: "Rich, creamy and deeply satisfying" },
        { name: "Chole Masala (Q)", price: 90, emoji: "🧆", description: "Aromatic bliss served hot and ready to delight" },
        { name: "Chole Masala (H)", price: 150, emoji: "🧆", description: "Aromatic bliss served hot and ready to delight" },
        { name: "Chole Masala (F)", price: 210, emoji: "🧆", description: "Aromatic bliss served hot and ready to delight" },
        { name: "Kaddi Pakoda (Q)", price: 90, emoji: "🍢", description: "Tangy, thick and absolutely lip-smacking good" },
        { name: "Kaddi Pakoda (H)", price: 150, emoji: "🍢", description: "Tangy, thick and absolutely lip-smacking good" },
        { name: "Kaddi Pakoda (F)", price: 210, emoji: "🍢", description: "Tangy, thick and absolutely lip-smacking good" },
        { name: "Shahi Paneer (Q)", price: 140, emoji: "🧀", description: "Royally creamy with premium taste" },
        { name: "Shahi Paneer (H)", price: 200, emoji: "🧀", description: "Royally creamy with premium taste" },
        { name: "Shahi Paneer (F)", price: 260, emoji: "🧀", description: "Royally creamy with premium taste" },
        { name: "Paneer Butter Masala (Q)", price: 140, emoji: "🧀", description: "The ultimate comfort dish you can't resist" },
        { name: "Paneer Butter Masala (H)", price: 200, emoji: "🧀", description: "The ultimate comfort dish you can't resist" },
        { name: "Paneer Butter Masala (F)", price: 270, emoji: "🧀", description: "The ultimate comfort dish you can't resist" },
        { name: "Palak Paneer (Q)", price: 140, emoji: "🥬", description: "Green goodness with rich, creamy perfection" },
        { name: "Palak Paneer (H)", price: 200, emoji: "🥬", description: "Green goodness with rich, creamy perfection" },
        { name: "Palak Paneer (F)", price: 260, emoji: "🥬", description: "Green goodness with rich, creamy perfection" },
        { name: "Paneer Lababdar (Q)", price: 140, emoji: "🧀", description: "A stunning blend of sweetness and spice" },
        { name: "Paneer Lababdar (H)", price: 200, emoji: "🧀", description: "A stunning blend of sweetness and spice" },
        { name: "Paneer Lababdar (F)", price: 270, emoji: "🧀", description: "A stunning blend of sweetness and spice" },
        { name: "Matar Paneer (Q)", price: 140, emoji: "🌱", description: "Fresh, vibrant and absolutely delightful" },
        { name: "Matar Paneer (H)", price: 200, emoji: "🌱", description: "Fresh, vibrant and absolutely delightful" },
        { name: "Matar Paneer (F)", price: 260, emoji: "🌱", description: "Fresh, vibrant and absolutely delightful" },
        { name: "Paneer Makhani (Q)", price: 140, emoji: "🧀", description: "Velvety smoothness with rich, buttery notes" },
        { name: "Paneer Makhani (H)", price: 200, emoji: "🧀", description: "Velvety smoothness with rich, buttery notes" },
        { name: "Paneer Makhani (F)", price: 260, emoji: "🧀", description: "Velvety smoothness with rich, buttery notes" },
        { name: "Paneer Do Payaza (Q)", price: 140, emoji: "🧀", description: "Sweet and spectacular feast of flavors" },
        { name: "Paneer Do Payaza (H)", price: 200, emoji: "🧀", description: "Sweet and spectacular feast of flavors" },
        { name: "Paneer Do Payaza (F)", price: 270, emoji: "🧀", description: "Sweet and spectacular feast of flavors" },
        { name: "Dal Tadka (Q)", price: 90, emoji: "🍲", description: "Lentil magic with fragrant, aromatic touch" },
        { name: "Dal Tadka (H)", price: 150, emoji: "🍲", description: "Lentil magic with fragrant, aromatic touch" },
        { name: "Dal Tadka (F)", price: 210, emoji: "🍲", description: "Lentil magic with fragrant, aromatic touch" },
        { name: "Dal Makhani (Q)", price: 150, emoji: "🍲", description: "Luxuriously creamy lentil masterpiece" },
        { name: "Dal Makhani (H)", price: 180, emoji: "🍲", description: "Luxuriously creamy lentil masterpiece" },
        { name: "Dal Makhani (F)", price: 240, emoji: "🍲", description: "Luxuriously creamy lentil masterpiece" },
        { name: "Dal Fry (Q)", price: 100, emoji: "🍲", description: "Perfectly spiced simplicity at its finest" },
        { name: "Dal Fry (H)", price: 160, emoji: "🍲", description: "Perfectly spiced simplicity at its finest" },
        { name: "Dal Fry (F)", price: 210, emoji: "🍲", description: "Perfectly spiced simplicity at its finest" },
        { name: "Chana Masala (Q)", price: 110, emoji: "🧆", description: "Warm, inviting and deeply flavored" },
        { name: "Chana Masala (H)", price: 170, emoji: "🧆", description: "Warm, inviting and deeply flavored" },
        { name: "Chana Masala (F)", price: 210, emoji: "🧆", description: "Warm, inviting and deeply flavored" },
        { name: "Mix Veg (Q)", price: 120, emoji: "🥦", description: "Vibrant medley of garden fresh goodness" },
        { name: "Mix Veg (H)", price: 180, emoji: "🥦", description: "Vibrant medley of garden fresh goodness" },
        { name: "Mix Veg (F)", price: 240, emoji: "🥦", description: "Vibrant medley of garden fresh goodness" },
        { name: "Kadhai Paneer (Q)", price: 140, emoji: "🍛", description: "Bold, smoky and absolutely unforgettable" },
        { name: "Kadhai Paneer (H)", price: 200, emoji: "🍛", description: "Bold, smoky and absolutely unforgettable" },
        { name: "Kadhai Paneer (F)", price: 260, emoji: "🍛", description: "Bold, smoky and absolutely unforgettable" },
        { name: "Tawa Paneer (Q)", price: 140, emoji: "🍲", description: "Charred, succulent and bursting with flavor" },
        { name: "Tawa Paneer (H)", price: 210, emoji: "🍲", description: "Charred, succulent and bursting with flavor" },
        { name: "Tawa Paneer (F)", price: 260, emoji: "🍲", description: "Charred, succulent and bursting with flavor" },
        { name: "Paneer Tikka Masala (Q)", price: 140, emoji: "🍗", description: "Smoky tandoor magic meets creamy dreams" },
        { name: "Paneer Tikka Masala (H)", price: 210, emoji: "🍗", description: "Smoky tandoor magic meets creamy dreams" },
        { name: "Paneer Tikka Masala (F)", price: 270, emoji: "🍗", description: "Smoky tandoor magic meets creamy dreams" },
        { name: "Tawa Chaap (Q)", price: 140, emoji: "🥩", description: "Tender, smoky and utterly mouth-watering" },
        { name: "Tawa Chaap (H)", price: 200, emoji: "🥩", description: "Tender, smoky and utterly mouth-watering" },
        { name: "Tawa Chaap (F)", price: 260, emoji: "🥩", description: "Tender, smoky and utterly mouth-watering" },
        { name: "Kadhai Chaap (Q)", price: 140, emoji: "🥩", description: "Spicy thrill meets incredible tenderness" },
        { name: "Kadhai Chaap (H)", price: 200, emoji: "🥩", description: "Spicy thrill meets incredible tenderness" },
        { name: "Kadhai Chaap (F)", price: 260, emoji: "🥩", description: "Spicy thrill meets incredible tenderness" }
    ],
    nonVeg: [
        { name: "Chicken Curry (Q)", price: 170, emoji: "🍗", description: "Silky, savory and packed with soul" },
        { name: "Chicken Curry (H)", price: 260, emoji: "🍗", description: "Silky, savory and packed with soul" },
        { name: "Chicken Curry (F)", price: 360, emoji: "🍗", description: "Silky, savory and packed with soul" },
        { name: "Egg Curry (Q)", price: 120, emoji: "🥚", description: "Soft, tender and immensely satisfying" },
        { name: "Egg Curry (H)", price: 190, emoji: "🥚", description: "Soft, tender and immensely satisfying" },
        { name: "Egg Curry (F)", price: 260, emoji: "🥚", description: "Soft, tender and immensely satisfying" },
        { name: "Crazy Butter Chicken (Q)", price: 170, emoji: "🍗", description: "Decadently rich with an incredible kick" },
        { name: "Crazy Butter Chicken (H)", price: 260, emoji: "🍗", description: "Decadently rich with an incredible kick" },
        { name: "Crazy Butter Chicken (F)", price: 330, emoji: "🍗", description: "Decadently rich with an incredible kick" },
        { name: "Tawa Chicken (Q)", price: 180, emoji: "🍗", description: "Smoky seared perfection with char marks" },
        { name: "Tawa Chicken (H)", price: 270, emoji: "🍗", description: "Smoky seared perfection with char marks" },
        { name: "Tawa Chicken (F)", price: 420, emoji: "🍗", description: "Smoky seared perfection with char marks" },
        { name: "Kadhai Chicken (Q)", price: 170, emoji: "🍗", description: "Bold spices with tender, juicy bites" },
        { name: "Kadhai Chicken (H)", price: 260, emoji: "🍗", description: "Bold spices with tender, juicy bites" },
        { name: "Kadhai Chicken (F)", price: 380, emoji: "🍗", description: "Bold spices with tender, juicy bites" },
        { name: "Rara Chicken (Q)", price: 200, emoji: "🍗", description: "Minced magic with a spicy, smoky soul" },
        { name: "Rara Chicken (H)", price: 300, emoji: "🍗", description: "Minced magic with a spicy, smoky soul" },
        { name: "Rara Chicken (F)", price: 480, emoji: "🍗", description: "Minced magic with a spicy, smoky soul" },
        { name: "Chicken Tikka Masala (Q)", price: 180, emoji: "🍗", description: "Restaurant-style perfection in every spoonful" },
        { name: "Chicken Tikka Masala (H)", price: 270, emoji: "🍗", description: "Restaurant-style perfection in every spoonful" },
        { name: "Chicken Tikka Masala (F)", price: 390, emoji: "🍗", description: "Restaurant-style perfection in every spoonful" },
        { name: "Tandoori Chaap (H)", price: 179, emoji: "🔥", description: "Smoky tandoor magic with incredible char" },
        { name: "Tandoori Chaap (F)", price: 249, emoji: "🔥", description: "Smoky tandoor magic with incredible char" },
        { name: "Malai Chaap (H)", price: 199, emoji: "🔥", description: "Creamy, succulent and absolutely divine" },
        { name: "Malai Chaap (F)", price: 279, emoji: "🔥", description: "Creamy, succulent and absolutely divine" },
        { name: "Tandoori Chicken (H)", price: 329, emoji: "🍗", description: "Tandoor perfection with smoky, aromatic allure" },
        { name: "Tandoori Chicken (F)", price: 569, emoji: "🍗", description: "Tandoor perfection with smoky, aromatic allure" },
        { name: "Afghani Chicken (H)", price: 259, emoji: "🍗", description: "Legendary flavors meet pure indulgence" },
        { name: "Afghani Chicken (F)", price: 569, emoji: "🍗", description: "Legendary flavors meet pure indulgence" },
        { name: "Mushroom Tikka", price: 299, emoji: "🍄", description: "Tender, smoky and surprisingly luxurious" },
        { name: "Paneer Tikka", price: 259, emoji: "🧀", description: "Tandoor-kissed chunks of pure delight" },
        { name: "Malai Paneer Tikka (H)", price: 259, emoji: "🧀", description: "Creamy, succulent and melts like butter" },
        { name: "Malai Paneer Tikka (F)", price: 399, emoji: "🧀", description: "Creamy, succulent and melts like butter" },
        { name: "Achari Paneer Tikka (H)", price: 249, emoji: "🧀", description: "Tangy spiced wonder with perfect char" },
        { name: "Achari Paneer Tikka (F)", price: 399, emoji: "🧀", description: "Tangy spiced wonder with perfect char" },
        { name: "Chicken Tikka (H)", price: 319, emoji: "🍗", description: "Charred, juicy and packed with flavor" },
        { name: "Chicken Tikka (F)", price: 499, emoji: "🍗", description: "Charred, juicy and packed with flavor" },
        { name: "Malai Chicken Tikka (H)", price: 329, emoji: "🍗", description: "Creamy marination meets smoky perfection" },
        { name: "Malai Chicken Tikka (F)", price: 499, emoji: "🍗", description: "Creamy marination meets smoky perfection" },
        { name: "Achari Chaap (H)", price: 249, emoji: "🔥", description: "Tangy, spicy and outrageously delicious" },
        { name: "Achari Chaap (F)", price: 299, emoji: "🔥", description: "Tangy, spicy and outrageously delicious" }
    ],
    breads: [
        { name: "Plain Tawa Roti", price: 12, emoji: "🍞", description: "Warm, light and perfect breakfast companion" },
        { name: "Butter Tawa Roti", price: 15, emoji: "🥖", description: "Golden, buttery and irresistibly soft" },
        { name: "Betroot Roti", price: 30, emoji: "🥖", description: "Colorful goodness with nutritious appeal" },
        { name: "Tandoori Roti", price: 18, emoji: "🥖", description: "Blistered, smoky and wonderfully rustic" },
        { name: "Laccha Paratha", price: 49, emoji: "🥞", description: "Layered, flaky and absolutely indulgent" },
        { name: "Butter Naan", price: 40, emoji: "🥐", description: "Soft, fluffy and glazed to perfection" },
        { name: "Plain Naan", price: 40, emoji: "🥐", description: "Classic, pillowy and wonderfully versatile" },
        { name: "Garlic Naan", price: 45, emoji: "🧄", description: "Aromatic, garlicky and utterly irresistible" },
        { name: "Pudina Paratha", price: 45, emoji: "🌿", description: "Fresh, minty and incredibly flavorful" }
    ],
    snacks: [
        { name: "Payaz Pakode", price: 119, emoji: "🧅", description: "Crispy, golden and bursting with aroma" }
    ],
    riceBiryani: [
        { name: "Steam Rice (H)", price: 70, emoji: "🍚", description: "Fluffy, fragrant and perfectly cooked" },
        { name: "Steam Rice (F)", price: 110, emoji: "🍚", description: "Fluffy, fragrant and perfectly cooked" },
        { name: "Jeera Rice (H)", price: 80, emoji: "🍚", description: "Fragrant, aromatic and absolutely delightful" },
        ...
        { name: "Veg Biryani (H)", price: 189, emoji: "🍲", description: "Royal feast with tantalizing aromas" },
        { name: "Veg Biryani (F)", price: 249, emoji: "🍲", description: "Royal feast with tantalizing aromas" },
        { name: "Chicken Biryani (H)", price: 199, emoji: "🍗", description: "Legendary one-pot magic with premium taste" },
        { name: "Chicken Biryani (F)", price: 279, emoji: "🍗", description: "Legendary one-pot magic with premium taste" },
        { name: "Egg Biryani (H)", price: 199, emoji: "🥚", description: "Aromatic, layered and deeply satisfying" },
